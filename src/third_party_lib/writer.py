# =================================================================
# NOTE:
# This code is external third-party code from Peter Hinch's
# font-to-py library (github.com/peterhinch/micropython-font-to-py).
# Newer versions should be overwritten by the maintainer of this
# project, but not changed within this project.
# =================================================================
